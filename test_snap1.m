...
%     b3=A*x3;
    ...
    init=l;
    t0=tic;
    [c0x1, c0y1] = CBCD_size1_gc(A, b1, d, iters,pre1,l,u,init);
    tC01=toc(t0);t0=tic;
    [~, c0y2] = CBCD_size2_gc(A, b1, d, iters,pre1,l,u,init);
    tC02=toc(t0);t0=tic;
    [~, c0y3] = CBCD_size3_gc(A, b1, d, iters,pre1,l,u,init);
    tC03=toc(t0);t0=tic;
    ...
    init=u;
    t0=tic;
    [c1x1, c1y1] = CBCD_size1_gc(A, b1, d, iters,pre1,l,u,init);
    tC01=toc(t0);t0=tic;
    [~, c1y2] = CBCD_size2_gc(A, b1, d, iters,pre1,l,u,init);
    tC02=toc(t0);t0=tic;
    [~, c1y3] = CBCD_size3_gc(A, b1, d, iters,pre1,l,u,init);
    tC03=toc(t0);t0=tic;
    [~, r1y3] = RBCD3(A, b1, d, iters,pre1,l,u,init,1.0);
    tR03=toc(t0);t0=tic;
    [~, r1y2] = RBCD2(A, b1, d, iters,pre1,l,u,init,1.0);
    tR02=toc(t0);t0=tic;
    [~, r1y1] = RBCD_size1_gc_u(A, b1, d, iters,pre1,l,u,init,1.0);
    tR01=toc(t0);
    ...
    init=(l+u)/2;
    t0=tic;
    [c5x1, c5y1] = CBCD_size1_gc(A, b1, d, iters,pre1,l,u,init);
    tC01=toc(t0);t0=tic;
    [~, c5y2] = CBCD_size2_gc(A, b1, d, iters,pre1,l,u,init);
    tC02=toc(t0);t0=tic;
    [~, c5y3] = CBCD_size3_gc(A, b1, d, iters,pre1,l,u,init);
    tC03=toc(t0);t0=tic;
    [~, r5y3] = RBCD3(A, b1, d, iters,pre1,l,u,init,1.0);
    tR03=toc(t0);t0=tic;
    [~, r5y2] = RBCD2(A, b1, d, iters,pre1,l,u,init,1.0);
    tR02=toc(t0);t0=tic;
    [~, r5y1] = RBCD_size1_gc_u(A, b1, d, iters,pre1,l,u,init,1.0);
    tR01=toc(t0);
    ...
    init=l;
    t0=tic;
    [c0ax1, c0ay1] = CBCD_size1_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC11=toc(t0);t0=tic;
    [~, c0ay2] = CBCD_size2_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC12=toc(t0);t0=tic;
    [~, c0ay3] = CBCD_size3_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC13=toc(t0);t0=tic;
    [~, r0ay3] = RBCD3(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR13=toc(t0);t0=tic;
    [~, r0ay2] = RBCD2(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR12=toc(t0);t0=tic;
    [~, r0ay1] = RBCD_size1_gc_u(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR11=toc(t0);
    % plot original matrix with init 0
    figure(4),
    clf;
    ...
    init=u;
    t0=tic;
    [c1ax1, c1ay1] = CBCD_size1_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC11=toc(t0);t0=tic;
    [~, c1ay2] = CBCD_size2_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC12=toc(t0);t0=tic;
    [~, c1ay3] = CBCD_size3_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC13=toc(t0);t0=tic;
    [~, r1ay3] = RBCD3(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR13=toc(t0);t0=tic;
    [~, r1ay2] = RBCD2(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR12=toc(t0);t0=tic;
    [~, r1ay1] = RBCD_size1_gc_u(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR11=toc(t0);
    % plot original matrix with init 1
    figure(5),
    clf;
    ...
    init=(u+l)/2;
    t0=tic;
    [c5ax1, c5ay1] = CBCD_size1_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC11=toc(t0);t0=tic;
    [~, c5ay2] = CBCD_size2_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC12=toc(t0);t0=tic;
    [~, c5ay3] = CBCD_size3_gc(A_amd, b1_amd, d, iters,pre1,l,u,init);
    tC13=toc(t0);t0=tic;
    [~, r5ay3] = RBCD3(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR13=toc(t0);t0=tic;
    [~, r5ay2] = RBCD2(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR12=toc(t0);t0=tic;
    [~, r5ay1] = RBCD_size1_gc_u(A_amd, b1_amd, d, iters,pre1,l,u,init,1.0);
    tR11=toc(t0);
    % plot original matrix with init 0.5
    figure(6),
    clf;
    ...
    init=l;
    t0=tic;
    [c0rx1, c0ry1] = CBCD_size1_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC21=toc(t0);t0=tic;
    [~, c0ry2] = CBCD_size2_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC22=toc(t0);t0=tic;
    [~, c0ry3] = CBCD_size3_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC23=toc(t0);t0=tic;
    [~, r0ry3] = RBCD3(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR23=toc(t0);t0=tic;
    [~, r0ry2] = RBCD2(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR22=toc(t0);t0=tic;
    [~, r0ry1] = RBCD_size1_gc_u(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR21=toc(t0);
    % plot original matrix with init 0
    figure(7),
    clf;
    ...
    init=u;
    t0=tic;
    [c1rx1, c1ry1] = CBCD_size1_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC21=toc(t0);t0=tic;
    [~, c1ry2] = CBCD_size2_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC22=toc(t0);t0=tic;
    [~, c1ry3] = CBCD_size3_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC23=toc(t0);t0=tic;
    [~, r1ry3] = RBCD3(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR23=toc(t0);t0=tic;
    [~, r1ry2] = RBCD2(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR22=toc(t0);t0=tic;
    [~, r1ry1] = RBCD_size1_gc_u(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR21=toc(t0);
    % plot original matrix with init 1
    figure(8),
    clf;
    ...
    init=(u+l)/2;
    t0=tic;
    [c5rx1, c5ry1] = CBCD_size1_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC21=toc(t0);t0=tic;
    [~, c5ry2] = CBCD_size2_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC22=toc(t0);t0=tic;
    [~, c5ry3] = CBCD_size3_gc(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    tC23=toc(t0);t0=tic;
    [~, r5ry3] = RBCD3(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR23=toc(t0);t0=tic;
    [~, r5ry2] = RBCD2(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR22=toc(t0);t0=tic;
    [~, r5ry1] = RBCD_size1_gc_u(A_rcm, b1_rcm, d, iters,pre1,l,u,init,1.0);
    tR21=toc(t0);
    % plot original matrix with init 1
    figure(9),
    clf;
