...
for i=1:N
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' Mat  '(b3); i=' num2str(i) '/' num2str(N) '; A done  ||']);
    disp('----------------------------------------');
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' Mat  '(b3); i=' num2str(i) '/' num2str(N) '; A_amd done  ||']);
    disp('----------------------------------------');
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' Mat  '(b3); i=' num2str(i) '/' num2str(N) '; A_rcm done  ||']);
    disp('----------------------------------------');
