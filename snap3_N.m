...
%     disp('----------------------------------------');
%     disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matlist,1)) '; A_1 done  ||']);
%     disp('----------------------------------------');
  ...
  [c5x1,c5y1] = CBCD1(A, b1, d, iters,pre1,l,u,init);
    ...
    saveas(gca,[saveDir 'b3/figure_A5.pdf']);
...
%     disp('----------------------------------------');
 ...
 [c5ax1,c5ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    saveas(gca,[saveDir 'b3/figure_A5amd.pdf']);
...
%     disp('----------------------------------------');
 ...
 [c5rx1,c5ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    saveas(gca,[saveDir 'b3/figure_A5rcm.pdf']);
...
%     fprintf(fid,'%s\n',datestr(now,0)); 
%     fprintf(fid,'exp No. %d/%d finished.\n',i,size(matlist,1));
%     fclose(fid);
end
